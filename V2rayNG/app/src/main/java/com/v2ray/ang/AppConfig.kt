...
object AppConfig {
    ...
    const val APP_URL = "$GITHUB_URL/nanima1/HbrayNG"
    const val APP_API_URL = "https://api.github.com/repos/nanima1/HbrayNG/releases"
    const val APP_ISSUES_URL = "$APP_URL/issues"
    const val APP_WIKI_MODE = "$APP_URL/wiki/Mode"
    const val APP_PRIVACY_POLICY = "$GITHUB_RAW_URL/2dust/v2rayNG/master/CR.md"
    const val TG_CHANNEL_URL = "https://t.me/Sakurachiritei"
