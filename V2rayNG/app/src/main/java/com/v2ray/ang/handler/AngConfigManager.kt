...
object AngConfigManager {
    ...
    fun shareNonCustomConfigsToClipboard(context: Context, serverList: List<String>): Int {
        try {
            val text = exportNonCustomConfigs(serverList)
    ...
    /**
     * Exports non-custom configurations as shareable URI lines.
     *
     * @param serverList The list of server GUIDs.
     * @return Subscription text containing one URI per line.
     */
    fun exportNonCustomConfigs(serverList: List<String>): String {
